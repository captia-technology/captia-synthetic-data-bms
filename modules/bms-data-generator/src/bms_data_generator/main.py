...
from bms_data_generator.rate_limit import RateLimitExceeded, limiter
...
def create_app() -> FastAPI:
    ...
    # H-03 (AUDIT_REPORT): rate limiting en endpoints /v1/* via slowapi.
    # La configuración por endpoint vive en cada router con @limiter.limit(...).
