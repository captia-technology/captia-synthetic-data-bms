...
"""),
        ...
        common_summary(next_notebook="02_case_B_energy_forecasting/02_bronze_to_silver_energy.ipynb",
                       docs_link="docs/use-cases/case-b-energy-forecasting.md"),
    ]
    return emit(target=target, rel_path="02_case_B_energy_forecasting/01_eda_consumo_electrico.ipynb",
...
def _bronze_silver(target: Path) -> Path:
    ...
    sections = [
        ...
        section(6, "Datos de entrada",
                "Mismo CSV que el notebook anterior. Si tienes BDG2 completo, sustituye el "
                "path."),
        section(7, "Schema CAPTIA esperado",
...
"""),
        ...
        section(17, "Cómo se reutiliza con datos reales",
                ...
                "es idéntico."),
        common_summary(next_notebook="02_case_B_energy_forecasting/03_features_forecasting.ipynb",
                       docs_link="docs/contracts/influx-schema.md"),
    ]
    return emit(target=target, rel_path="02_case_B_energy_forecasting/02_bronze_to_silver_energy.ipynb",
...
"""),
        ...
        common_summary(next_notebook="02_case_B_energy_forecasting/04_baseline_sarima_xgboost_lstm.ipynb",
                       docs_link="docs/use-cases/case-b-energy-forecasting.md"),
    ]
    return emit(target=target, rel_path="02_case_B_energy_forecasting/03_features_forecasting.ipynb",
...
"""),
        ...
        common_summary(next_notebook="02_case_B_energy_forecasting/05_validacion_modelo_24h.ipynb",
                       docs_link="docs/validation/ml-validation.md"),
    ]
    return emit(target=target, rel_path="02_case_B_energy_forecasting/04_baseline_sarima_xgboost_lstm.ipynb",
                title=title, case=CASE, layer="oro", spec=SPEC, sections=sections)
...
"""),
        ...
        common_summary(next_notebook="03_case_C_hvac_anomaly_detection/01_eda_hvac_fdd.ipynb",
                       docs_link="docs/validation/ml-validation.md"),
    ]
    return emit(target=target, rel_path="02_case_B_energy_forecasting/05_validacion_modelo_24h.ipynb",
                title=title, case=CASE, layer="oro", spec=SPEC, sections=sections)
