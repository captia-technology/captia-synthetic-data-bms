...
def _overview(target: Path) -> Path:
    ...
    sections = [
        ...
        setup_section(),
        section(9, "Carga de datos o mock", "Cargamos el subset.",
                """\
...
"""),
        section(10, "Exploración paso a paso", "Tabla de operaciones a benchmarkar.",
                """\
ops = pd.DataFrame(
    [
...
sizes
"""),
        section(14, "Validaciones", "El subset tiene < 100k filas (clase).",
                """\
...
"""),
        ...
        section(17, "Cómo se reutiliza con datos reales", "Descarga BDG2 desde Zenodo y "
                "cambia el path al CSV completo."),
        common_summary(next_notebook="09_case_I_spark_vs_pandas/02_benchmark_pandas.ipynb",
                       docs_link="docs/use-cases/case-i-spark-pandas.md"),
    ]
    return emit(target=target, rel_path="09_case_I_spark_vs_pandas/01_bdg2_overview.ipynb",
...
df.head()
"""),
        section(10, "Exploración paso a paso", "Funciones a medir.",
                """\
import time
...
"""),
        ...
        section(12, "Construcción de capa oro", "Loop benchmark.",
                """\
ops = {
...
bench_pd
"""),
        section(13, "Visualizaciones explicativas", "Bar chart pandas.",
                """\
...
plt.tight_layout()
"""),
        section(14, "Validaciones", "Resultados son finite floats.",
                """\
...
"""),
        ...
        common_summary(next_notebook="09_case_I_spark_vs_pandas/03_benchmark_spark.ipynb",
                       docs_link="docs/use-cases/case-i-spark-pandas.md"),
    ]
    return emit(target=target, rel_path="09_case_I_spark_vs_pandas/02_benchmark_pandas.ipynb",
...
def _spark(target: Path) -> Path:
    ...
    sections = [
        ...
        section(7, "Schema CAPTIA esperado", "No aplica."),
        setup_section(),
        section(9, "Carga de datos o mock", "Detectamos backend.",
                """\
...
"""),
        section(10, "Exploración paso a paso", "Operaciones equivalentes.",
                """\
import time
...
"""),
        ...
        section(13, "Visualizaciones explicativas", "Plot si hay datos.",
                """\
if not bench_spark.empty:
    ...
    plt.tight_layout()
"""),
        section(14, "Validaciones", "Si hay backend, los tiempos son positivos.",
                """\
if not bench_spark.empty:
...
"""),
        ...
        common_summary(next_notebook="09_case_I_spark_vs_pandas/04_comparativa_resultados.ipynb",
                       docs_link="docs/use-cases/case-i-spark-pandas.md"),
    ]
    return emit(target=target, rel_path="09_case_I_spark_vs_pandas/03_benchmark_spark.ipynb",
                title=title, case=CASE, layer="bronce → plata", spec=SPEC, sections=sections)
...
def _comparativa(target: Path) -> Path:
    ...
    sections = [
        section(1, "Objetivo",
                "Combinar los resultados de los notebooks 02 y 03 y emitir una "
                "recomendación clara."),
        section(2, "Qué se aprende",
        ...
        section(7, "Schema CAPTIA esperado", "No aplica."),
        setup_section(),
        section(9, "Carga de datos o mock", "Combinamos resultados de demo.",
                """\
...
combined
"""),
        section(10, "Exploración paso a paso", "En subsets pequeños pandas gana.",
                """\
...
"""),
        section(11, "Transformación bronce → plata", "No aplica."),
        section(12, "Construcción de capa oro", "Plot speedup.",
                """\
...
plt.tight_layout()
"""),
        section(13, "Visualizaciones explicativas", "Recomendación textual.",
                """\
...
"""),
        section(14, "Validaciones", "El cruce está en escala log.",
                """\
...
"""),
        ...
        common_summary(next_notebook="10_case_J_traffic_yolo/01_captura_imagenes_dgt.ipynb",
                       docs_link="docs/use-cases/case-i-spark-pandas.md"),
    ]
    return emit(target=target, rel_path="09_case_I_spark_vs_pandas/04_comparativa_resultados.ipynb",
