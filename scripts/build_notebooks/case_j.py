...
def _captura(target: Path) -> Path:
    ...
    sections = [
        ...
        section(3, "Contexto del caso de uso",
                "Jorge (G5) trabaja en remoto desde Galicia. El pipeline debe operar "
                "desatendido."),
        ...
        setup_section(),
        section(9, "Carga de datos o mock", "Generamos un fake JPEG.",
                """\
import io
...
"""),
        ...
        section(13, "Visualizaciones explicativas", "Mostramos el JPEG mock.",
                """\
plt.imshow(Image.open(io.BytesIO(img_bytes)))
plt.axis("off"); plt.title("Imagen mock con coches simulados")
plt.tight_layout()
"""),
        section(14, "Validaciones", "El path generado es estable.",
                """\
...
"""),
        ...
        common_summary(next_notebook="10_case_J_traffic_yolo/02_inferencia_yolo.ipynb",
                       docs_link="docs/use-cases/case-j-traffic-yolo.md"),
    ]
    return emit(target=target, rel_path="10_case_J_traffic_yolo/01_captura_imagenes_dgt.ipynb",
...
"""),
        section(10, "Exploración paso a paso", "Probamos con varias imágenes.",
                """\
import io
...
"""),
        ...
        common_summary(next_notebook="10_case_J_traffic_yolo/03_series_temporales_trafico.ipynb",
                       docs_link="docs/use-cases/case-j-traffic-yolo.md"),
    ]
    return emit(target=target, rel_path="10_case_J_traffic_yolo/02_inferencia_yolo.ipynb",
...
df.head()
"""),
        section(10, "Exploración paso a paso", "Resumen por cámara.",
                """\
...
"""),
        section(12, "Construcción de capa oro", "Notebook 04."),
        section(13, "Visualizaciones explicativas", "Conteo medio por hora.",
                """\
...
"""),
        ...
        common_summary(next_notebook="10_case_J_traffic_yolo/04_integracion_meteo_trafico.ipynb",
                       docs_link="docs/use-cases/case-j-traffic-yolo.md"),
    ]
    return emit(target=target, rel_path="10_case_J_traffic_yolo/03_series_temporales_trafico.ipynb",
                title=title, case=CASE, layer="bronce → plata", spec=SPEC, sections=sections)
...
df.head()
"""),
        section(10, "Exploración paso a paso", "Correlación.",
                """\
...
"""),
        ...
        common_summary(next_notebook=None,
                       docs_link="docs/use-cases/case-j-traffic-yolo.md",
                       extra_bullets=("¡Has completado los 42 notebooks didácticos!",
                                       "Vuelve a `00_project_overview/00_arquitectura_medallion_captia.ipynb` para revisitar el mapa.")),
    ]
    return emit(target=target, rel_path="10_case_J_traffic_yolo/04_integracion_meteo_trafico.ipynb",
