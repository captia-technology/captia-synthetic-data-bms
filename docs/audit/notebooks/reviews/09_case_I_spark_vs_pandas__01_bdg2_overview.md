# Review — `notebooks/09_case_I_spark_vs_pandas/01_bdg2_overview.ipynb`
...
| Campo | Valor |
|---|---|
| Ruta | `notebooks/09_case_I_spark_vs_pandas/01_bdg2_overview.ipynb` |
| Título | Caso I · 01 BDG2 overview — el dataset de 53M registros |
| Celdas md / code | 23 / 5 |
| Secciones distintas | 22 |
| Outputs persistidos | 4 / 5 (80.0%) |
...
<!-- AUTO -->
Notebook **01_bdg2_overview** del caso **Big Data**, etapa **01** (capa Bronce → Plata (EDA)). Score **8.1/10**, veredicto **B**. 4/5 celdas de código con outputs persistidos (80.0%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
...
- Outputs persistidos celda a celda (80.0%).
