# Review — `notebooks/04_case_D_iaq_occupancy/05_validacion_iaq_confort.ipynb`
...
> **Score:** **7.9 / 10** · Veredicto **C** · Prioridad **P2**

## Ficha técnica

| Campo | Valor |
|---|---|
| Ruta | `notebooks/04_case_D_iaq_occupancy/05_validacion_iaq_confort.ipynb` |
| Título | Caso D · 05 Alertas IAQ con histéresis y jerarquía L1/L2/L3 |
| Celdas md / code | 23 / 6 |
...
| Datasets detectados | ERA5 Xàtiva (público mockeado), In-Gauge AULA01 (sintético) |

## 1. Resumen ejecutivo

<!-- AUTO -->
Notebook **05_validacion_iaq_confort** del caso **IAQ + Occupancy**, etapa **05** (capa Oro (Validación)). Score **7.9/10**, veredicto **C**. 6/6 celdas de código con outputs persistidos (100.0%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
