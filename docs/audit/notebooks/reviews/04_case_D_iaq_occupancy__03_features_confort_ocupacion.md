# Review — `notebooks/04_case_D_iaq_occupancy/03_features_confort_ocupacion.ipynb`
...
| Campo | Valor |
|---|---|
| Ruta | `notebooks/04_case_D_iaq_occupancy/03_features_confort_ocupacion.ipynb` |
| Título | Caso D · 03 Features para predicción de ocupación |
| Celdas md / code | 23 / 6 |
...
<!-- AUTO -->
Notebook **03_features_confort_ocupacion** del caso **IAQ + Occupancy**, etapa **03** (capa Plata → Oro (Features)). Score **8.5/10**, veredicto **B**. 6/6 celdas de código con outputs persistidos (100.0%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
