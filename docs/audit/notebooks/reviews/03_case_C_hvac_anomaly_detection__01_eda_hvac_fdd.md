# Review — `notebooks/03_case_C_hvac_anomaly_detection/01_eda_hvac_fdd.ipynb`
...
| Campo | Valor |
|---|---|
| Ruta | `notebooks/03_case_C_hvac_anomaly_detection/01_eda_hvac_fdd.ipynb` |
| Título | Caso C · 01 EDA HVAC y catálogo de fallos |
| Celdas md / code | 23 / 6 |
...
<!-- AUTO -->
Notebook **01_eda_hvac_fdd** del caso **Anomaly Detection**, etapa **01** (capa Bronce → Plata (EDA)). Score **8.6/10**, veredicto **B**. 6/6 celdas de código con outputs persistidos (100.0%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
