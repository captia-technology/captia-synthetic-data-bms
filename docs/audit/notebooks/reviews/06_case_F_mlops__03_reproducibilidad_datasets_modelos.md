# Review — `notebooks/06_case_F_mlops/03_reproducibilidad_datasets_modelos.ipynb`
...
| Campo | Valor |
|---|---|
| Ruta | `notebooks/06_case_F_mlops/03_reproducibilidad_datasets_modelos.ipynb` |
| Título | Caso F · 03 Reproducibilidad — hash dataset, hash modelo |
| Celdas md / code | 23 / 6 |
...
<!-- AUTO -->
Notebook **03_reproducibilidad_datasets_modelos** del caso **MLOps**, etapa **03** (capa Plata → Oro (Features)). Score **8.1/10**, veredicto **B**. 5/6 celdas de código con outputs persistidos (83.3%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
