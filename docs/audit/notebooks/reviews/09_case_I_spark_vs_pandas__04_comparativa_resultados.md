# Review — `notebooks/09_case_I_spark_vs_pandas/04_comparativa_resultados.ipynb`
...
| Campo | Valor |
|---|---|
| Ruta | `notebooks/09_case_I_spark_vs_pandas/04_comparativa_resultados.ipynb` |
| Título | Caso I · 04 Benchmark medido — pandas vs polars vs duckdb |
| Celdas md / code | 23 / 6 |
...
| Datasets detectados | BDG2 educational (público resampled), DGT cameras (sintético) |

## 1. Resumen ejecutivo

<!-- AUTO -->
Notebook **04_comparativa_resultados** del caso **Big Data**, etapa **04** (capa Oro (Modelado)). Score **8.1/10**, veredicto **B**. 5/6 celdas de código con outputs persistidos (83.3%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
