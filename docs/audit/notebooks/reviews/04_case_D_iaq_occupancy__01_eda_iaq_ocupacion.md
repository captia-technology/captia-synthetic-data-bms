# Review — `notebooks/04_case_D_iaq_occupancy/01_eda_iaq_ocupacion.ipynb`
...
| Campo | Valor |
|---|---|
| Ruta | `notebooks/04_case_D_iaq_occupancy/01_eda_iaq_ocupacion.ipynb` |
| Título | Caso D · 01 EDA IAQ y ocupación en aulas |
| Celdas md / code | 23 / 5 |
...
<!-- AUTO -->
Notebook **01_eda_iaq_ocupacion** del caso **IAQ + Occupancy**, etapa **01** (capa Bronce → Plata (EDA)). Score **8.6/10**, veredicto **B**. 5/5 celdas de código con outputs persistidos (100.0%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
