# Review — `notebooks/03_case_C_hvac_anomaly_detection/03_features_anomalias_hvac.ipynb`
...
| Campo | Valor |
|---|---|
| Ruta | `notebooks/03_case_C_hvac_anomaly_detection/03_features_anomalias_hvac.ipynb` |
| Título | Caso C · 03 Features para detección de anomalías HVAC |
| Celdas md / code | 23 / 6 |
...
<!-- AUTO -->
Notebook **03_features_anomalias_hvac** del caso **Anomaly Detection**, etapa **03** (capa Plata → Oro (Features)). Score **8.4/10**, veredicto **B**. 6/6 celdas de código con outputs persistidos (100.0%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
