# Review — `notebooks/07_case_G_data_quality_agents/02_reglas_calidad_plata_influxdb.ipynb`
...
> **Score:** **7.6 / 10** · Veredicto **C** · Prioridad **P2**

## Ficha técnica

| Campo | Valor |
|---|---|
| Ruta | `notebooks/07_case_G_data_quality_agents/02_reglas_calidad_plata_influxdb.ipynb` |
| Título | Caso G · 02 Reglas Flux sobre la capa plata |
| Celdas md / code | 23 / 6 |
...
<!-- AUTO -->
Notebook **02_reglas_calidad_plata_influxdb** del caso **Data Quality + Agents**, etapa **02** (capa Bronce → Plata (ETL)). Score **7.6/10**, veredicto **C**. 6/6 celdas de código con outputs persistidos (100.0%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
