# Review — `notebooks/01_case_A_pipeline_iot/01_explicacion_pipeline_centinela.ipynb`
...
| Campo | Valor |
|---|---|
| Ruta | `notebooks/01_case_A_pipeline_iot/01_explicacion_pipeline_centinela.ipynb` |
| Título | Pipeline IoT CENTINELA+ — explicación de las 5 capas |
| Celdas md / code | 23 / 7 |
...
<!-- AUTO -->
Notebook **01_explicacion_pipeline_centinela** del caso **Pipeline IoT**, etapa **01** (capa Bronce → Plata (EDA)). Score **7.9/10**, veredicto **C**. 7/7 celdas de código con outputs persistidos (100.0%). Sin bugs P0/P1 reportados. Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
