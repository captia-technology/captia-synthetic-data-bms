# Review — `notebooks/08_case_H_rag_chatbot/05_evaluacion_chatbot.ipynb`
...
> **Score:** **8.2 / 10** · Veredicto **B** · Prioridad **P2**

## Ficha técnica

| Campo | Valor |
|---|---|
| Ruta | `notebooks/08_case_H_rag_chatbot/05_evaluacion_chatbot.ipynb` |
| Título | Caso H · 05 Evaluación del chatbot con golden set |
| Celdas md / code | 23 / 6 |
...
<!-- AUTO -->
Notebook **05_evaluacion_chatbot** del caso **RAG + Chatbot**, etapa **05** (capa Oro (Validación)). Score **8.2/10**, veredicto **B**. 6/6 celdas de código con outputs persistidos (100.0%). Bugs P0/P1 documentados (ver §6). Helpers `_common` reutilizados: `captia_schema`, `connection`, `plotting`, `synthetic_mocks`.
